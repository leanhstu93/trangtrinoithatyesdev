...
class VideoCategoryController extends Controller
{
	...
	public function actionCreate()
	{
		...
		{
			$model->attributes=$_POST['VideoCategory'];
			if($model->save()) {

                //xu ly node
                $alias = Common::bodau($model->name);
                $insert_id = Yii::app()->db->getLastInsertID();
                Router::processRouter(['alias' => $alias, 'idObject' => $insert_id, 'type' =>Router::TYPE_VIDEO_CATEGORY]);
                //end xu ly node
	...
	public function actionDelete($id)
	{
        ...
        #xu ly router
        Router::processRouter(['alias' => '', 'idObject' => $id, 'type' => Router::TYPE_VIDEO_CATEGORY], 'delete');
        #End xu ly router
	...
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='video-category-form')
		{
