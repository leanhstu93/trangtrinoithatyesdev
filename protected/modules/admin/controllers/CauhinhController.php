...
class CauhinhController extends Controller
{
	...
	{
		$dataProvider=new CActiveDataProvider('Cauhinh');
	...
	{
		$model=Cauhinh::model()->findByPk($id);
		if($model===null)
	 ...
	 * @param Cauhinh $model the model to be validated
	 */
	protected function performAjaxValidation($model)
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='cauhinh-form')
		{
