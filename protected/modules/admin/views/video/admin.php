...
<div class="page-header">
    <h1 class="title">Quản lý video</h1>
    <ol class="breadcrumb">
        ...
        <div class="col-md-12">
            <div class="panel panel-default">
                <div class="panel-title">
                    ...
                    <a class="btn btn-default createCourse" href="<?php echo Yii::app()->request->baseUrl ?>/admin/them-video.html">Thêm video</a>
                </div>
                            ...
                            'columns' => array(
                                ...
                                array(
                                 ...
                                 array(
                                    'name'=>'SetHome',
                                    'type'=>'raw',
                                    'value'=>'$data->SetHome == 0 ? "<span style=\"color:red;font-size:22px\" state=\"1\" class=\"fa fa-close\" ></span>":"<span style=\"color:#399bff;font-size:22px\" state=\"1\" class=\"fa fa-check\" ></span>"',
