...
<div class="form-group" style="margin-bottom:0px">
    ...
    <label class="col-sm-2 control-label form-label" for="input001">Loại video:</label>

    <div class="col-sm-6"> <?php
        $criteria=new CDbCriteria();
        $criteria->condition = "active = 1";
        $videoCategory = VideoCategory::model()->findAll($criteria);
        $listdata = CHtml::listData($videoCategory,'id','name');
        echo $form->dropDownList($model, 'idCategory',$listdata, array( 'class' => 'form-control ')); ?>
        <span class="help-block" id="helpBlock"><?php echo $form->error($model,'idCategory'); ?></span> </div>
</div>
...
<div class="form-group" style="margin-bottom:0px">
    ...
    <div class="col-sm-6">
        ...
        <?php echo $form->textField($model, 'UrlImage', array('size' => 60, 'maxlength' => 100, 'class' => 'form-control', 'style'=>'width:80%;float:left;margin-right: 17px;')); ?>
...
<div class="form-group">
    ...
    <div class="col-sm-offset-2 col-sm-10">
        ...
        <?php echo CHtml::submitButton($model->isNewRecord ? 'Thêm video' : 'Lưu video'); ?>
