...
<div class="form-group" style="margin-bottom:0px">
 ...
 <div class="tt_tv">
   <div class="form-group" style="margin-bottom:0px">
    ...
    <div class="col-sm-6">
        <?php echo $form->textField($sli,'Name',array('size'=>60,'maxlength'=>100,'class'=>'form-control')); ?>
...
<div class="form-group" style="margin-bottom:0px">
    ...
    <div class="col-sm-6">
        <?php echo $form->textArea($sli,'Description',array('size'=>60,'maxlength'=>100,'class'=>'form-control')); ?>
...
<div class="form-group">
    <div class="col-sm-offset-2 col-sm-10">
        <?php echo CHtml::submitButton($model->isNewRecord ? 'Thêm slide' : 'Lưu slide'); ?>
    </div>
</div>
<script>
    function setFile(url)
    {
        jQuery('#Slide_UrlImage').val(url);
