        ...
        <div class="col-md-12">
            <div class="panel panel-default">
                <div class="panel-title">
                    ...
                    <a class="btn btn-default createCourse" href="<?php echo Yii::app()->request->baseUrl ?>/admin/them-slide.html">Thêm slide</a>
                </div>
                        ...
                        $this->widget('zii.widgets.grid.CGridView', array(
                            ...
                            'columns' => array(
                                ...
                                array(
                                    'name'=>'Type',
                                    'type'=>'raw',
                                    'value'=>'$data->Type == 0 ? "Banner":"Hình ảnh công ty"',
                                    'filter'=>array(1=>'Hình ảnh công ty',0=>'Banner')
                                    ),
                                array(
                                    'name'=>'Active',
                                    'type'=>'raw',
