...
<div class="page-header">
    ...
    <ol class="breadcrumb">
        ...
        <li class="active">Quản lý rao vặt</li>
    </ol>
</div>
<!-- End Page Header -->
        ...
        <div class="col-md-12">
            <div class="panel panel-default">
                <div class="panel-title">
                    <h1>Quản lý rao vặt</h1>
                    <ul class="panel-tools">
                        <li><a class="icon expand-tool"><i class="fa fa-expand"></i></a></li>
                    </ul>
                    <a class="btn btn-default createCourse" href="<?php echo Yii::app()->request->baseUrl ?>/admin/them-rao-vat.html">Thêm rao vặt</a>
                </div>
