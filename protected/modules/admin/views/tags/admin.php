...
<div class="page-header">
    ...
    <ol class="breadcrumb">
        ...
        <li class="active"><a href="<?php echo Yii::app()->homeUrl ?>admin/quan-ly-tags.html">Quản lý tags </a></li>
    </ol>
</div>
<!-- End Page Header -->
        ...
        <div class="col-md-12">
            <div class="panel panel-default ad-qllt">
                <div class="panel-title">
                    ...
                    <a class="btn btn-default createCourse" href="<?php echo Yii::app()->request->baseUrl ?>/admin/them-tags.html">Thêm tags</a>
                </div>
