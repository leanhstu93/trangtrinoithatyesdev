...
<div class="page-header">
    ...
    <ol class="breadcrumb">
        ...
        <li class="active"><a href="<?php echo Yii::app()->homeUrl ?>admin/quan-ly-loai-san-pham.html">Quản lý loại sản phẩm </a></li>
    </ol>
</div>
<!-- End Page Header -->
        ...
        <div class="col-md-12">
            <div class="panel panel-default ad-qllt">
                <div class="panel-title">
                    ...
                    <a class="btn btn-default createCourse" href="<?php echo Yii::app()->request->baseUrl ?>/admin/them-loai-san-pham.html">Thêm loại sản phẩm</a>
                </div>
                        ...
                        $this->widget('zii.widgets.grid.CGridView', array(
                            ...
                            'columns' => array(
                                ...
                                array(
                                    ...
                                    'filter'=>array(1=>'Tiếng việt',2=>'Tiếng Anh')
                                    ),
                                array(
                                    'class' => 'CButtonColumn',
                                    ...
                                    'buttons' => array(
                                        'update' => array(
                                            ...
                                            'url' =>'Yii::app()->homeUrl."admin/sua-loai-san-pham/".$data->id.".html"'
                                        ),
                                        'delete' => array(
                                            'label' => '',
                                            'imageUrl' => '',
                                            'url'=>'Yii::app()->homeUrl."admin/loaisanpham/delete/id/".$data->id.".html"',
