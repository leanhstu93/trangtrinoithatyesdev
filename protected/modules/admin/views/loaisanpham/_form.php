...
<div class="form-group" style="margin-bottom:0px">
    ...
    <div class="col-sm-6">
        <?php echo $form->textField($model,'TenLoai',array('size'=>60,'maxlength'=>100,'class'=>'form-control Ta__js-title')); ?>
 ...
 <div class="form-group" style="margin-bottom:0px">
        ...
        <div class="col-sm-6">
            <?php echo $form->textField($tt,'Alias',array('size'=>60,'maxlength'=>100,'class'=>'form-control Ta__js-alias', 'required'=>'required')); ?>
            <span class="help-block" id="helpBlock"><?php echo $form->error($tt,'Alias',array("text"=>"aaa")); ?></span>
        </div>
        <div class="col-sm-4">
