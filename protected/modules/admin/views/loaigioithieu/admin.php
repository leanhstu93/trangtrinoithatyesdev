...
<div class="page-header">
    ...
    <ol class="breadcrumb">
        ...
        <li class="active"><a href="<?php echo Yii::app()->homeUrl ?>admin/quan-ly-loai-tin.html">Quản lý loại tin </a></li>
    </ol>
</div>
<!-- End Page Header -->
        ...
        <div class="col-md-12">
            <div class="panel panel-default ad-qllt">
                <div class="panel-title">
                    ...
                    <a class="btn btn-default createCourse" href="<?php echo Yii::app()->request->baseUrl ?>/admin/them-loai-tin.html">Thêm loại tin</a>
                </div>
                                ...
                                array(
                                    ...
                                    'buttons' => array(
                                        'update' => array(
                                            ...
                                            'url' =>'Yii::app()->homeUrl."admin/sua-loai-tin/".$data->id.".html"'
                                        ),
                                        'delete' => array(
                                            'label' => '',
                                            'imageUrl' => '',
