...
/**
 * This is the model class for table "loaitin_lang".
 *
 * The followings are the available columns in table 'loaitin_lang':
 * @property integer $id
 ...
 */
class LoaitinLang extends CActiveRecord
{
	/**
	 ...
	 * @return LoaitinLang the static model class
	 */
